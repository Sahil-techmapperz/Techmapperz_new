...
import { Map, Zap, TreePine, Route, Mountain, Landmark, Building2 } from "lucide-react";
...
const gisServices = [
  {
    ...
    image: "/GIS_Services_OUR_GIS_SERVICES/GIS-Mapping&Data-Digitisation.png",
  ...
  },
  {
    ...
    image: "/GIS_Services_OUR_GIS_SERVICES/GIS-Data-Prepared-for-the-Way-Your-Project-Works.png",
  ...
  },
  {
    ...
    image: "/GIS_Services_OUR_GIS_SERVICES/Utility,Pipeline&Asset-Mapping.png",
  ...
  },
  {
    ...
    image: "/GIS_Services_OUR_GIS_SERVICES/Cadastral-map.png",
  ...
  },
  {
    ...
    link: "/contact",
    image: "/GIS_Services_OUR_GIS_SERVICES/Land-Use&Land-Cover-(LULC)-Mapping.png",
...
export default function GISServicePageClient() {
  ...
  return (
    <div className="bg-white text-gray-900 font-sans antialiased">
      ...
      {/* 1. HERO SECTION */}
      <section className="relative min-h-[auto] sm:min-h-[85vh] flex flex-col justify-start sm:justify-center items-start text-white pt-32 sm:pt-40 pb-16 sm:pb-24 overflow-hidden">
        <Image
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
            ...
            <div>
              <div className="relative h-[300px] sm:h-[400px] rounded-2xl overflow-hidden shadow-xl border border-white/10">
                <Image
                  src="/GIS_Services_OUR_GIS_SERVICES/GIS-Data-Prepared-for-the-Way-Your-Project-Works.png"
                  alt="GIS Data Prepared for the Way Your Project Works"
                  fill
