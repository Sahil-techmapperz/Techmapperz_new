...
const itPortfolioData = [
    ...
    {
        image: "/Photos/IT_portfolio/Expoguru/homepage.jpg",
        category: "Websites & Apps",
        client: "Project Expo Guru",
        role: "Website design & development",
        delivery: "Dynamic, responsive company website",
        headline: "A clearer digital presence for a creative business.",
        summary: "We developed a dynamic website that brings Project Expo Guru’s interior design and creative services into one professional, easy-to-explore online presence.",
        tags: ["Dynamic website", "Responsive layouts", "Service presentation"],
        seoTitle: "Project Expo Guru Website Case Study | Techmapperz",
        seoDescription: "How Techmapperz developed a dynamic website for Project Expo Guru, bringing its interior design and creative services into a clear, professional online presence.",
        techStack: "Dynamic Website Development, Responsive UI, Service-Focused Architecture, SEO-Friendly Structure, Content-Driven Design, Scalable Frontend Presentation",
        name: "Project Expo Guru — Creative Business Website",
        ...
        projectDetails: {
            ...
            projectType: "Dynamic, responsive company website",
            ourRole: "Website design & development",
            delivery: "Dynamic, responsive company website",
            location: "India",
            year: "2026"
        },
        challenges: [
            {
                title: "Balancing visual impact with practical business information",
                description: "A broad service offering can be difficult to explain online. Visitors needed to see what Project Expo Guru does, understand whether it suited their requirements and find a clear next step for an inquiry. The brief was to balance a strong visual first impression with practical business information."
            }
        ],
        solutionsSummary: "We organised the experience around three simple questions: Who is the company? What does it offer? How can a prospective client take the conversation forward?",
        solutions: [
            {
                title: "A clear company story",
                description: "We structured the company overview and service sections so visitors could move from an introduction to the business to the work most relevant to them.",
                features: [
                    "Structured service hierarchy",
                    "Clear company capabilities introduction",
                    "Intuitive user guidance"
                ]
            },
            {
                title: "Design that supports the work",
                description: "We developed a modern layout that gives the client’s visual content room to stand out, while keeping service descriptions and navigation easy to follow.",
                features: [
                    "Design-forward editorial aesthetics",
                    "Visual breathing space for portfolio work",
                    "Consistent typography and palette"
                ]
            },
            {
                title: "Responsive, dynamic development",
                description: "We developed responsive pages for desktop, tablet and mobile browsing, with a dynamic structure that supports future content, service and portfolio expansion.",
                features: [
                    "Fluid mobile & tablet navigation",
                    "Dynamic CMS/database ready architecture",
                    "Optimized asset loading"
                ]
            },
            {
                title: "A foundation for inquiries and search",
                description: "We organised the pages to support search visibility and refined the content flow to help visitors understand the services before making an inquiry.",
                features: [
                    "SEO-optimized semantic structure",
                    "High-converting inquiry touchpoints",
                    "Fast page load benchmarks"
                ]
            }
        ],
        executionSteps: [
            { step: "01", title: "Understand the business", desc: "Explored service offerings, creative portfolio, and client inquiry goals." },
            { step: "02", title: "Plan the content", desc: "Structured information architecture around key visitor questions." },
            { step: "03", title: "Design & develop", desc: "Crafted responsive layouts and dynamic frontend presentation." },
            { step: "04", title: "Refine for delivery", desc: "Optimized performance, SEO visibility, and inquiry pathways." }
        ],
        galleryImages: [
            {
        ...
        resultsLead: "The completed website gave Project Expo Guru a professional place to present its business and direct prospective clients. The value delivered was a clearer, more consistent online experience with room to grow.",
        results: [
            {
        ...
        conclusion: "The completed website gave Project Expo Guru a professional place to present its business and direct prospective clients. The value delivered was a clearer, more consistent online experience with room to grow.",
        testimonial: {
