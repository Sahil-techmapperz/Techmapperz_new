...
export default function IndustriesPage() {
  ...
  return (
    <div className="bg-white text-gray-900 font-sans antialiased">
      ...
      {/* SECTION 1: HERO */}
      <section
        className="relative min-h-[auto] sm:min-h-[65vh] md:min-h-[70vh] flex flex-col justify-center items-start bg-cover bg-center text-white pt-28 sm:pt-36 pb-12 sm:pb-16 md:pb-20"
      ...
      <section className="py-12 md:py-16 bg-[#f8fafc] border-b border-gray-100">
        <div className="max-w-[1400px] mx-auto px-4 sm:px-8 md:px-12 lg:px-20">
          <div className="text-center mb-10 md:mb-12">
            <span className="text-[#6ac045] text-xs font-bold uppercase tracking-[0.2em] mb-3 block">WHY INDUSTRY CONTEXT MATTERS</span>
      ...
      <section className="py-12 md:py-16 bg-white" id="industries">
        <div className="max-w-[1400px] mx-auto px-4 sm:px-8 md:px-12 lg:px-20">
          <div className="text-center mb-10 md:mb-12">
            <span className="text-[#6ac045] text-xs font-bold uppercase tracking-[0.2em] mb-3 block">SECTOR-SPECIFIC CAPABILITIES</span>
            <h2 className="text-3xl md:text-4xl font-bold text-[#0c2e60] tracking-tight mb-3">Industries We Support</h2>
      ...
      <section className="py-12 md:py-16 bg-[#f8fafc] border-y border-gray-100" id="projects">
        <div className="max-w-[1400px] mx-auto px-4 sm:px-8 md:px-12 lg:px-20">
          <div className="text-center mb-10 md:mb-12">
            <span className="text-[#6ac045] text-xs font-bold uppercase tracking-[0.2em] mb-3 block">DELIVERED PROJECT EXPERIENCE</span>
            <h2 className="text-3xl md:text-4xl font-bold text-[#0c2e60] tracking-tight mb-3">Experience Grounded in Real Project Work</h2>
      ...
      <section className="py-12 md:py-16 bg-white border-b border-gray-100">
        <div className="max-w-[1400px] mx-auto px-4 sm:px-8 md:px-12 lg:px-20">
          <div className="text-center mb-10 md:mb-12">
            <span className="text-[#6ac045] text-xs font-bold uppercase tracking-[0.2em] mb-3 block">DIGITAL WORKFLOWS</span>
            <h2 className="text-3xl md:text-4xl font-bold text-[#0c2e60] tracking-tight mb-3">When the Project Needs More Than a Static Map</h2>
            <p className="text-gray-600 text-base md:text-lg max-w-3xl mx-auto leading-relaxed">
      ...
      <section className="py-12 md:py-16 bg-[#f8fafc] border-b border-gray-100">
        <div className="max-w-[1400px] mx-auto px-4 sm:px-8 md:px-12 lg:px-20 text-center">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-[#0c2e60] mb-10 md:mb-12">From Source Data to Usable Deliverables</h2>
      ...
      <section className="py-12 md:py-16 bg-white">
        <div className="max-w-[1000px] mx-auto px-4 sm:px-8 md:px-12 lg:px-20">
          <div className="text-center mb-8 md:mb-10">
            <span className="text-[#6ac045] text-xs font-bold uppercase tracking-[0.2em] mb-3 block">FREQUENTLY ASKED QUESTIONS</span>
      ...
      <section className="py-8 md:py-12 bg-white border-t border-gray-100" id="contact">
