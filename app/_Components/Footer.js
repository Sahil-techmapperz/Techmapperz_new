...
import { LinkedInIcon, InstagramIcon, TwitterXIcon, FacebookIcon, YouTubeIcon } from "./SocialIcons";
...
const Footer = () => {
  ...
  const socials = [
    { icon: <LinkedInIcon />, href: 'https://www.linkedin.com/company/techmapperz/', label: 'LinkedIn' },
    { icon: <InstagramIcon />, href: 'https://www.instagram.com/techmapperz/', label: 'Instagram' },
    { icon: <TwitterXIcon />, href: 'https://x.com/Techmapperzllp', label: 'Twitter' },
    { icon: <FacebookIcon />, href: 'https://www.facebook.com/techmapperz', label: 'Facebook' },
    { icon: <YouTubeIcon />, href: 'https://www.youtube.com/channel/UCWogNBwwxTvoX8Ax24j6c6Q', label: 'YouTube' },
  ];
        ...
        <div className="relative z-10 max-w-[1600px] mx-auto px-5 sm:px-8 lg:px-12 pt-10 md:pt-12 pb-6 md:pb-8">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 md:gap-10 lg:gap-8">
            ...
            <div className="col-span-1">
              <h3 className="text-white font-bold text-xs sm:text-sm uppercase tracking-widest mb-3.5 sm:mb-4 relative pb-2 sm:pb-2.5 after:content-[''] after:absolute after:left-0 after:bottom-0 after:w-8 after:h-0.5 after:bg-[#D2292B] after:rounded-full">
                Company
              </h3>
              <ul className="flex flex-col gap-2.5 sm:gap-3">
                {navLinks.map(link => (
                  <li key={link.href}>
                    <Link
                      href={link.href}
                      className="group flex items-center gap-2 text-xs sm:text-sm py-1.5 min-h-[36px] transition-all duration-200"
                      style={{ color: '#a8c4e8' }}
                    >
                      <span className="w-1.5 h-1.5 rounded-full bg-[#D2292B] opacity-0 group-hover:opacity-100 transition-opacity shrink-0" />
            ...
            <div className="col-span-2 lg:col-span-1">
              ...
              <div className="flex flex-col gap-2.5">
                ...
                <input
                  ...
                  className="w-full rounded-xl px-4 py-2.5 text-xs sm:text-sm text-white outline-none focus:ring-2 focus:ring-[#1656B8] transition-all"
                ...
                <button
                  ...
                  className="w-full py-2.5 min-h-[46px] rounded-xl text-white font-bold text-xs sm:text-sm transition-all duration-200 bg-[#1656B8] hover:bg-[#0C2E60] active:scale-95 disabled:opacity-60 shadow-md border border-white/10"
                >
              ...
              {subscribeStatus && (
                <p className={`mt-2 text-xs font-medium ${subscribeStatus.toLowerCase().includes('success') ? 'text-teal-300' : 'text-red-400'}`}>
                  {subscribeStatus}
                </p>
              )}
            </div>
            ...
            <div className="flex flex-wrap justify-center items-center gap-3.5">
              {socials.map(({ icon, href, label }) => (
                <a
                  ...
                  aria-label={label}
                  className="w-11 h-11 rounded-full flex items-center justify-center text-sm sm:text-base transition-all duration-200 hover:scale-110"
