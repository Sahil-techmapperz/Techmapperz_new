    ...
    <>
      <div className="fixed top-0 w-full z-[200] flex flex-col">
        ...
        {isOpen && (
          ...
          >
            <div 
              className="fixed top-0 right-0 h-full w-[290px] sm:w-[320px] max-w-[85vw] bg-white shadow-xl transform transition-transform duration-300 p-6 flex flex-col overflow-y-auto"
            ...
            >
              ...
              <div className="flex justify-end mb-4">
                <button
                  onClick={onClose}
                  className="text-black text-2xl min-h-[44px] min-w-[44px] flex items-center justify-center hover:bg-gray-100 rounded-full transition-colors"
              ...
              {/* Drawer Links */}
              <nav className="flex flex-col gap-3 text-[#0c2e60] font-semibold text-base sm:text-lg" aria-label="Mobile navigation">
                <Link href="/" onClick={onClose} className="hover:text-[#d2292b] transition-colors py-1.5 min-h-[44px] flex items-center">
                  Home
                </Link>
                ...
                <div>
                  <div className="flex items-center justify-between min-h-[44px]">
                    <Link href="/service" onClick={onClose} className="hover:text-[#d2292b] transition-colors py-1.5 flex-grow flex items-center">
                      Services
                    </Link>
                    <button
                      type="button"
                      onClick={() => setIsServicesOpen(prev => !prev)}
                      className="p-2 min-h-[44px] min-w-[44px] flex items-center justify-center text-gray-500 hover:text-[#d2292b]"
                  ...
                  {isServicesOpen && (
                    <div className="pl-4 pb-2 flex flex-col gap-2 border-l-2 border-[#0c2e60]/10 ml-2 mt-1">
                      <Link
                        href="/service"
                        onClick={onClose}
                        className="text-sm font-semibold text-gray-700 hover:text-[#d2292b] py-1 min-h-[40px] flex items-center"
                      >
                        All Services
                      </Link>
                      <Link
                        ...
                        onClick={onClose}
                        className="text-sm font-normal text-gray-600 hover:text-[#d2292b] py-1 min-h-[40px] flex items-center"
                      >
                        GIS Services
                      </Link>
                      <Link
                      ...
                      <Link
                        href="/service/drone-data-processing"
                        onClick={onClose}
                        className="text-sm font-normal text-gray-600 hover:text-[#d2292b] py-1 min-h-[40px] flex items-center"
                      >
                ...
                <Link href="/industry" onClick={onClose} className="hover:text-[#d2292b] transition-colors py-1.5 min-h-[44px] flex items-center">
                  Industries
                </Link>

                <Link href="/portfolios" onClick={onClose} className="hover:text-[#d2292b] transition-colors py-1.5 min-h-[44px] flex items-center">
                  Projects
                </Link>
                ...
                <div>
                  <div className="flex items-center justify-between min-h-[44px]">
                    <Link href="/blog?page=1" onClick={onClose} className="hover:text-[#d2292b] transition-colors py-1.5 flex-grow flex items-center">
                      Insights
                    </Link>
                    <button
                      type="button"
                    ...
                    >
                      <ChevronDown
                        className={`w-5 h-5 transition-transform duration-200 ${isInsightsOpen ? 'rotate-180' : ''}`}
                      />
                    </button>
                  </div>
                  {isInsightsOpen && (
                ...
                <Link href="/about" onClick={onClose} className="hover:text-[#d2292b] transition-colors py-1.5 min-h-[44px] flex items-center">
                  About
                </Link>

                <Link href="/contact" onClick={onClose} className="hover:text-[#d2292b] transition-colors py-1.5 min-h-[44px] flex items-center">
                  Contact
                </Link>
              </nav>

              {/* Mobile CTA Buttons (matching PC view) */}
              <div className="flex flex-col gap-3 mt-auto pt-6 pb-2">
                <Link
                  href="/portfolios"
                  onClick={onClose}
                  className="w-full text-center py-3 min-h-[46px] rounded-xl border border-[#0C2E60] text-[#0C2E60] bg-white hover:bg-[#F6F8FB] font-bold text-sm shadow-sm flex items-center justify-center transition-colors"
                >
                  View Work
                </Link>
                <button
