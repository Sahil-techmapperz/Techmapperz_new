    ...
    <section className="py-8 px-20 max-sm:px-5 relative">
      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-4 backdrop-blur-sm">
          <div className="relative w-full max-w-lg rounded-2xl bg-white shadow-2xl overflow-hidden animate-in fade-in zoom-in-95">
            <div className="bg-[#396ba9] text-white p-4 flex justify-between items-center">
              <h3 className="font-bold text-lg border-b-2 border-red-500 pb-1">Job Info</h3>
              <button onClick={onClose} className="text-white/80 hover:text-white text-xl font-bold">✕</button>
            </div>
            <div className="p-6 space-y-2 max-h-[70vh] overflow-y-auto text-gray-800 text-sm">
            ...
            <div className="p-4 bg-gray-50 flex justify-end border-t border-gray-100">
              <button onClick={onClose} className="bg-[#396ba9] hover:bg-[#2e578c] text-white px-5 py-2 rounded-lg font-medium transition-colors">
                Close
              </button>
            </div>
          </div>
