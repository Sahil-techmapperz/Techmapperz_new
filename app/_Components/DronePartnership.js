...
const DronePartnership = () => {
  return (
    <>
      <section className="tm-partnership py-4 md:py-10">
        <div className="container">
          <div className="hero">
            <div className="content">
              ...
              <h2>Extend Your Processing Capacity Without Expanding Your Extra Team</h2>
          ...
          <div className="bottom-row">
            ...
            >
              ...
              <strong style={{ fontSize: '15px', fontWeight: '700', color: '#ffffff', lineHeight: '1.3' }}>
      ...
      <style jsx>{`
        ...
        .review-box {
          ...
          border-radius:12px;
          background:#FFFFFF;
          box-shadow: 0 4px 12px rgba(12, 46, 96, 0.04);
        }
        ...
        .review-icon svg { width:20px; height:20px; }
        ...
        .benefit svg { width:20px; height:20px; }
        ...
        .cta {
          ...
          box-shadow:0 6px 18px rgba(22,86,184,.25);
