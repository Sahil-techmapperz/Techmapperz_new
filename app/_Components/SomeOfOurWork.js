              ...
              >
                ...
                <div className="relative w-full h-48 md:h-56 rounded-xl mb-6 border border-gray-100">
                  ...
                  <div className="absolute bottom-0 right-4 translate-y-1/2 z-20">
                    <Link href={project.link} className="inline-flex items-center justify-center bg-[#078A86] text-white font-extrabold text-xs px-5 py-2.5 min-h-[44px] rounded-full shadow-lg hover:bg-[#1267B1] transition-all uppercase tracking-wider" style={sansSerifStyle}>
                      EXPLORE PROJECT
                    </Link>
                  </div>
                </div>
          ...
          >
            ...
            <div className="w-full md:w-[45%] flex flex-col justify-between">
              ...
              <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6 border-t border-gray-200 pt-4">
                <Link href={wideProject.link} className="inline-flex items-center justify-center bg-[#078A86] text-white font-extrabold text-xs px-5 py-2.5 min-h-[44px] rounded-full shadow-lg hover:bg-[#1267B1] transition-all uppercase tracking-wider self-start lg:self-auto" style={sansSerifStyle}>
                  EXPLORE PROJECT
                </Link>
